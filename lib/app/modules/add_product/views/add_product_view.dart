...
class AddProductView extends GetView<AddProductController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
        title: const Text('Add Product View', style: TextStyle(color: Colors.white)),
        centerTitle: true,
      ...
      body: ListView(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: Obx(
              () => Text(controller.isLoading.isFalse ? "ADD PRODUCT" : "LOADING...", style: const TextStyle(color: Colors.white)),
            ),
          ),
        ],
      ),
